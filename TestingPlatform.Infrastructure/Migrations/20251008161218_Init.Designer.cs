...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TestingPlatform.Domain.Enums.Answer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("TestingPlatform.Domain.Models.Class", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("TestingPlatform.Domain.Models.Questions", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("TestingPlatform.Domain.Enums.Answer", b =>
                {
                    b.HasOne("TestingPlatform.Domain.Models.Questions", "Question")
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("TestingPlatform.Domain.Models.UserAttemptsAnswer", b =>
                {
                    ...
                    b.HasOne("TestingPlatform.Domain.Models.Questions", "Questions")
            ...
            modelBuilder.Entity("TestingPlatform.Domain.Models.UserSelectedOption", b =>
                {
                    b.HasOne("TestingPlatform.Domain.Enums.Answer", "Answer")
                        .WithMany()
                        .HasForeignKey("AnswerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TestingPlatform.Domain.Enums.Answer", null)
            ...
            modelBuilder.Entity("TestingPlatform.Domain.Models.UserTextAnswer", b =>
                {
                    b.HasOne("TestingPlatform.Domain.Models.UserAttemptsAnswer", "UserAttemptsAnswer")
